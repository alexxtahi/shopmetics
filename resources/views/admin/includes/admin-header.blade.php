<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
        ...
        <input class="form-control admin-searchbar" type="search" placeholder="Recherche" aria-label="Search" data-width="250">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <div class="d-sm-none d-lg-inline-block">Bonjour, {{ Auth::user()->nom }}</div></a>
        <div class="dropdown-menu dropdown-menu-right">
            <div class="dropdown-title">{{ Auth::user()->nom . " " . Auth::user()->prenom }}</div>
            <a href="features-profile.html" class="dropdown-item has-icon">
            <i class="far fa-user"></i> Profil
            </a>
            <a href="features-activities.html" class="dropdown-item has-icon">
            <i class="fas fa-bolt"></i> Activités
            </a>
