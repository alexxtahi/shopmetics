        ...
        <div class="card">
            <div class="card-header table-card-header">
                ...
                <div class="table-card-action-btn">
                    <a href="{{ route('admin.pages.produits.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Ajouter un produit</a>
                    <a href="{{ route('admin.pages.produits.etat') }}" class="btn btn-warning" style="margin-left: 10px"><i class="fa fa-print"></i> Imprimer</a>
                </div>
            </div>
            <div class="card-body">
