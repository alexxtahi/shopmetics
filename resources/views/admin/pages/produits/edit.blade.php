            ...
            <div class="card">
                ...
                <div class="card-header table-card-header">
                    ...
                    <div class="table-card-action-btn">
                        <a href="{{ route('admin.pages.produits') }}" class="btn btn-danger"><i
                ...
                <div class="card-body">
                    ...
                    @if (isset($result) && !empty($result))
                        ...
                        @endswitch
                    @endif
                    <form action="{{ url('/dashboard/produits/update/' . $produit->id) }}" method="POST"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" id="code_prod" name="code_prod"
                                    placeholder="Code du produit" value="{{ $produit->code_prod }}" required>
                            </div>
                            <!-- Désignation -->
                            <div class="form-group col-md-6">
                                <label for="designation">Désignation *</label>
                                <input type="text" class="form-control" id="designation" name="designation"
                                    placeholder="Désignation du produit" value="{{ $produit->designation }}" required>
                            </div>
                            <!-- Prix -->
                            <div class="form-group col-md-3">
                                <label for="prix_prod">Prix *</label>
                                <input type="number" class="form-control" id="prix_prod" name="prix_prod"
                                    placeholder="Prix du produit" value="{{ $produit->prix_prod }}" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <!-- Catégorie -->
                                ...
                                <select class="form-control" id="id_cat" name="id_cat" required>
                                    ...
                                    @foreach ($categories as $categorie)
                                        @if ($categorie->id === $produit->id_cat)
                                            <option value="{{ $categorie->id }}" selected>{{ $categorie->lib_cat }}
                                            </option>
                                        @else
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" class="form-control" id="qte_prod" name="qte_prod"
                                    placeholder="Quantité du produit" value="{{ $produit->qte_prod }}">
                            </div>
                            <!-- Image -->
                            <div class="form-group col-md-6">
                                <label for="img_prod">Image</label>
                                <input type="file" class="form-control" id="img_prod" name="img_prod"
                                    value="{{ $produit->img_prod }}">
                            </div>
                        </div>
                        <!-- Description -->
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description"
                                placeholder="Donnez une description à votre produit ici">
                                {{ $produit->description }}
                            </textarea>
                        </div>
                        <!-- Actions -->
                        <div class="form-row form-footer">
                            ...
                            <button type="reset" class="btn btn-danger" style="margin-left: 10px;"><i
