            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if (isset($result) && !empty($result))
                        ...
                        @endswitch
                    @endif
                    <form action="{{ url('/dashboard/clients/update/' . $client->id) }}" method="POST"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="prenom" name="prenom"
                                    placeholder="Prénom du client" value="{{ $client->prenom }}" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <!-- Contact -->
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="Adresse mail du client" value="{{ $client->email }}" required>
                            </div>
                            <!-- Mot de passe -->
                            <div class="form-group col-md-4">
                                <label for="password">Mot de passe</label>
                                <input type="password" class="form-control" id="password" name="password"
                                    placeholder="Remplissez pour changer le mot de passe">
                            </div>
                        </div>
                        <div class="form-row">
                            <!-- Ville -->
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="ville" name="ville"
                                    placeholder="Ville du client" value="{{ $client->ville }}" required>
                            </div>
                            <!-- Commune -->
                            <div class="form-group col-md-6">
                                <label for="commune">Commune *</label>
                                <input type="text" class="form-control" id="commune" name="commune"
                                    placeholder="Commune du client" value="{{ $client->commune }}" required>
                            </div>
                        </div>
                        <!-- Actions -->
