                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" id="cun-name" value="SkinnyThé" disabled='true' style="font-weight:bold;">
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="order-total">
                                <ul class="order-table">
                                    ...
                                    @forelse ($cart as $item)
                                        ...
                                        <li class="fw-normal">{{$item->produits->designation}} x {{$item->qt_prod}} <span> {{ number_format($item->produits->prix_prod * $item->produits->qte_prod, 0, ',', ' ') }} FCFA</span></li>
                                        @php
                                    ...
                                    <li class="total-price">Total <span>{{ number_format($total, 0, ',', ' ') }} FCFA (TTC)</span></li>
                                </ul>
